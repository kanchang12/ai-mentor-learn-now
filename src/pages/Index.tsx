    ...
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <section className="relative min-h-screen">
        ...
        <div className="absolute top-32 left-12 max-w-2xl z-20">
          ...
          <h1 className="text-7xl font-black mb-8 leading-tight text-white">
            Master AI
            <br />
        ...
        <div className="absolute top-20 right-20 w-96 h-64 z-30">
          <Card className="bg-gray-800/90 backdrop-blur-xl border-gray-600 overflow-hidden">
            <CardContent className="p-0">
              <div className="aspect-video bg-gradient-to-br from-gray-700 to-gray-800 flex items-center justify-center relative">
                ...
                <div className="absolute bottom-4 left-4 z-10">
                  ...
                  <p className="text-gray-200 text-sm">12:34 • 2.1M views</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="absolute bottom-32 left-20 z-30">
          <Card className="bg-gray-800/90 backdrop-blur-xl border-gray-600 p-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-200">Students Learning</p>
              </div>
            </div>
          </Card>
        </div>
          ...
          <Card className="bg-gray-800/90 backdrop-blur-xl border-gray-600 p-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-200">Student Rating</p>
              </div>
            </div>
          </Card>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="relative">
            ...
            <div className="absolute top-0 left-0 w-80 z-20">
              <Card className="bg-gray-800/90 backdrop-blur-xl border-blue-500/50 p-8">
                <Brain className="h-12 w-12 text-blue-400 mb-6" />
                <h3 className="text-2xl font-bold text-white mb-4">AI Companion</h3>
                <p className="text-gray-200">Get instant help and explanations while learning. Your personal AI tutor is always there.</p>
              </Card>
            </div>

            {/* Feature 2 - center right, overlapping */}
            <div className="absolute top-16 right-20 w-80 z-30">
              <Card className="bg-gray-800/90 backdrop-blur-xl border-purple-500/50 p-8">
                <Zap className="h-12 w-12 text-purple-400 mb-6" />
                <h3 className="text-2xl font-bold text-white mb-4">Hands-On Learning</h3>
                <p className="text-gray-200">Build real projects while learning. No theory-only courses - practice with actual AI tools.</p>
              </Card>
            </div>

            {/* Feature 3 - bottom left, overlapping */}
            <div className="absolute top-32 left-40 w-80 z-25">
              <Card className="bg-gray-800/90 backdrop-blur-xl border-green-500/50 p-8">
                <TrendingUp className="h-12 w-12 text-green-400 mb-6" />
                <h3 className="text-2xl font-bold text-white mb-4">Track Progress</h3>
                <p className="text-gray-200">See your learning journey with detailed analytics and achievements to keep you motivated.</p>
              </Card>
            </div>

            {/* Feature 4 - far right */}
            <div className="absolute top-48 right-0 w-80 z-20">
              <Card className="bg-gray-800/90 backdrop-blur-xl border-yellow-500/50 p-8">
                <Sparkles className="h-12 w-12 text-yellow-400 mb-6" />
                <h3 className="text-2xl font-bold text-white mb-4">Latest AI Tools</h3>
                <p className="text-gray-200">Stay updated with the newest AI tools and techniques. Content updated weekly.</p>
              </Card>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-12 gap-6 h-96">
            <Link to="/general" className="col-span-4 row-span-2">
              <Card className="h-full bg-gray-800/90 backdrop-blur-xl border-blue-500/50 p-8 hover:scale-105 transition-all cursor-pointer">
                <div className="text-6xl mb-6">🤖</div>
                <h3 className="text-2xl font-bold text-white mb-4">General AI</h3>
                <p className="text-gray-200">Master ChatGPT, Claude & AI fundamentals</p>
                <Badge className="mt-4 bg-blue-600 text-white">12 Tutorials</Badge>
              </Card>
            </Link>

            <Link to="/writing" className="col-span-4">
              <Card className="h-full bg-gray-800/90 backdrop-blur-xl border-green-500/50 p-6 hover:scale-105 transition-all cursor-pointer">
                <div className="text-4xl mb-4">✍️</div>
                <h3 className="text-xl font-bold text-white mb-2">Writing</h3>
                <p className="text-gray-200 text-sm">Content creation mastery</p>
              </Card>
            </Link>

            <Link to="/images" className="col-span-4">
              <Card className="h-full bg-gray-800/90 backdrop-blur-xl border-purple-500/50 p-6 hover:scale-105 transition-all cursor-pointer">
                <div className="text-4xl mb-4">🎨</div>
                <h3 className="text-xl font-bold text-white mb-2">Images</h3>
                <p className="text-gray-200 text-sm">Midjourney & DALL-E</p>
              </Card>
            </Link>

            <Link to="/business" className="col-span-3">
              <Card className="h-full bg-gray-800/90 backdrop-blur-xl border-yellow-500/50 p-6 hover:scale-105 transition-all cursor-pointer">
                <div className="text-4xl mb-4">⚡</div>
                <h3 className="text-lg font-bold text-white mb-2">Business</h3>
                <p className="text-gray-200 text-xs">Automation</p>
              </Card>
            </Link>

            <Link to="/data" className="col-span-3">
              <Card className="h-full bg-gray-800/90 backdrop-blur-xl border-red-500/50 p-6 hover:scale-105 transition-all cursor-pointer">
                <div className="text-4xl mb-4">📊</div>
                <h3 className="text-lg font-bold text-white mb-2">Data</h3>
                <p className="text-gray-200 text-xs">Analytics</p>
              </Card>
            </Link>

            <Link to="/website" className="col-span-2">
              <Card className="h-full bg-gray-800/90 backdrop-blur-xl border-teal-500/50 p-6 hover:scale-105 transition-all cursor-pointer">
                <div className="text-4xl mb-4">💻</div>
          ...
          <Card className="bg-gray-800/90 backdrop-blur-xl border-gray-600 p-6">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div>
                ...
                <p className="text-gray-200 text-sm">Marketing Director</p>
              </div>
            </div>
